...
export default function HeroBannerDefault({
  ...
  slice:
    | Content.HeroBannerSliceDefault
    | Content.HeroBannerSliceWithButton
    | Content.HeroBannerSliceWithoutDescription;
}) {
  return (
    <Section
      noStyle
      ...
      <div className="relative flex flex-col gap-6 md:gap-12 max-w-5xl mx-auto text-center">
        ...
        {slice.variation === "withButton" && (
          ...
          <Link className="self-center" href={slice.primary.cta_link?.url}>
            <Button
              type="primary"
              color={slice.primary.cta_type === "1" ? "black" : "purple-haze"}
              testId="order-pack"
              size="large"
            >
